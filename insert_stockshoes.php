...
// Insert new record into shoe_sizes_quantity table
$sql = "INSERT INTO shoe_sizes_quantity (product_id, size_id, quantity) VALUES ('$product_id', '$size_id', '$quantity')";
...
// Query database for available shoe sizes
$sql = "SELECT id, Velikost FROM shoe_sizing";

$result = $conn->query($sql);

if ($result->num_rows > 0) {
// Display form to add new shoe size and quantity
echo "<h2>Add New Shoe Size and Quantity</h2>";
echo "<form method='post' action='insert_stockshoes.php'>";
...
echo "No shoe sizes found. Please add shoe sizes first.";
}
